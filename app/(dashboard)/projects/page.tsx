    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="text-body-16 mt-1 text-[#4f4638]">
                    ...
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          ...
                          className="inline-flex h-9 w-9 items-center justify-center rounded-md border border-[#8a6500]/30 text-[#7a5c0a] transition hover:border-[#8a6500]/60 hover:text-[#8a6500]"
      ...
      >
        <DialogContent className="max-w-md border-[#8a6500]/60 bg-[linear-gradient(180deg,_#E6E1DB_0%,_#847C69_98.36%)]">
          <DialogHeader>
            <DialogTitle className="text-[#8a6500]">Delete Project</DialogTitle>
            <DialogDescription className="text-[#4f4638]">
              Are you sure you want to delete{" "}
              <span className="font-semibold text-[#3f372b]">
          ...
          <DialogFooter>
            <Button
              type="button"
              variant="outline"
              className="h-11 border-[#8a6500] bg-transparent text-[#8a6500] hover:bg-[#8a6500]/10"
            ...
            <Button
              type="button"
              className="h-11 bg-[#8a6500] text-white hover:bg-[#735500]"
              onClick={() => {
